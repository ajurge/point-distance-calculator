...
# https://travis-ci.org/ajurge/point-distance-calculator --> More Options --> Trigger Build
#env:
#  global:
...
TRAVIS_CI_BUILD_REST_API_URL=https://api.travis-ci.org/repo/ajurge%2Fpoint-distance-calculator/requests
